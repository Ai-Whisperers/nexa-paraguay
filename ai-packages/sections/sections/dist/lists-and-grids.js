...
export function TeamSection({ pageContent, data, images }) {
    ...
    if (!members.length)
        return null;
    return (_jsx("section", { className: "py-24 bg-surface-alt", children: _jsxs("div", { className: "max-w-[900px] mx-auto text-center px-4", children: [d.title && _jsx("h2", { className: "text-[clamp(1.4rem,2.5vw,2rem)] font-bold text-primary mb-8", children: d.title }), _jsx("div", { className: "grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-8", children: members.map((m, i) => {
...
export function BlogSection({ pageContent, data, images, locale: _locale }) {
    ...
    if (!posts.length)
        return null;
    return (_jsx("section", { className: "py-24", children: _jsxs("div", { className: "max-w-[900px] mx-auto px-4", children: [d.title && _jsx("h2", { className: "text-[clamp(1.4rem,2.5vw,2rem)] font-bold text-primary mb-8 text-center", children: d.title }), _jsx("div", { className: "grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6", children: posts.map((post, i) => {
