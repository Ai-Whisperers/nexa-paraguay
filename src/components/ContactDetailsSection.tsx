  ...
  return (
    <section className="py-20 md:py-24">
      <div className="max-w-lg mx-auto px-4">
        {d.title && (
          <h2 className="text-[clamp(1.3rem_2.5vw_1.8rem)] font-bold text-primary text-center mb-8">{d.title}</h2>
        )}
        ...
        <div className="space-y-3">
          ...
          {phoneClean && (
            <a
              ...
              className="flex items-center gap-4 p-4 rounded-xl no-underline font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
          ...
          {d.email && (
            <a
              href={`mailto:${d.email}`}
              className="flex items-center gap-4 p-4 rounded-xl no-underline font-semibold bg-primary text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
            >
          ...
          {/* Address */}
          {d.address && (
            <div className="flex items-center gap-4 p-4 rounded-xl bg-surface-alt border border-border/50">
