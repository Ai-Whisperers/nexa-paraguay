# Nexa Paraguay — Documentation Index

> **Last updated:** 2026-05-11 | **Repo:** github.com/Ai-Whisperers/nexa-paraguay
> **Live:** nexa.paragu-ai.com | **Primary domain:** nexaparaguay.com (parked on Shopify)
...
## 2. MEETING RECORDS (docs/meetings/)
...
| Category | Count | Avg Rating | GPS |
|----------|-------|-----------|-----|
| Gyms & Fitness | 366 | 4.60★ | ✅ |
| Beauty & Hair | 146 | 4.63★ | ✅ |
| Spas & Wellness | 95 | 4.55★ | ✅ |
| Cafes | 23 | 4.49★ | ✅ |
| Clothing Stores | 23 | 4.60★ | ✅ |
| Bars | 19 | 4.31★ | ✅ |
| Banks | 20 | 3.72★ | ✅ |
| Bakeries | 18 | 4.64★ | ✅ |
| Parks | 19 | 4.19★ | ✅ |
| Gas Stations | 19 | 4.21★ | ✅ |
| Dentists | 12 | 4.77★ | ✅ |
| Doctors | 10 | 4.63★ | ✅ |
| **30+ more categories** | | | ✅ |
...
|------|----------|----------------|
| **Brand guide** | `docs/03-brand/brand-guide.md` | Color palette, typography, tone |
| **Social assets** | `docs/03-brand/social-assets.md` | Social media asset specs |
| **Image manifest** | `docs/04-images/images-manifest.md` | Image manifest (82 entries) |
| **Image prompts** | `docs/04-images/image-generation-prompts.md` | AI image generation prompts |
