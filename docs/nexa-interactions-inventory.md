...
5. Share buttons (where present): opens Messaging/X/LinkedIn/Facebook share windows.
...
| `asistente` | /es/asistente<br>/en/asistente<br>/nl/asistente<br>/de/asistente | header, hero, intake-wizard, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `benelux` | /es/benelux<br>/en/benelux<br>/nl/benelux<br>/de/benelux | header, hero, trust-signals, why-destination, faq, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Type in FAQ search<br>- Clear search<br>- Expand/collapse question<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `blog` | /es/blog<br>/en/blog<br>/nl/blog<br>/de/blog | header, hero, blog-index, newsletter-signup, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Filter by category<br>- Paginate prev/next<br>- Open article<br>- Fill email (if rendered)<br>- Submit signup<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | - POST /api/contact (if wired in page variant) |
| `calidad-de-vida` | /es/calidad-de-vida<br>/en/calidad-de-vida<br>/nl/calidad-de-vida<br>/de/calidad-de-vida | header, hero, pillars, comparison-table, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
| `comparacion` | /es/comparacion<br>/en/comparacion<br>/nl/comparacion<br>/de/comparacion | header, hero, comparison-table, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `comparar` | /es/comparar<br>/en/comparar<br>/nl/comparar<br>/de/comparar | header, hero, comparison-table, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `contacto` | /es/contacto<br>/en/contacto<br>/nl/contacto<br>/de/contacto | header, hero, booking-embed, contact, footer | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Open booking URL<br>- Fallback to Messaging<br>- Open Messaging<br>- Open mail client<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true) | — |
...
| `deutschland` | /es/deutschland<br>/en/deutschland<br>/nl/deutschland<br>/de/deutschland | header, hero, story, comparison-table, process-timeline, programs, guides, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `empresa` | /es/empresa<br>/en/empresa<br>/nl/empresa<br>/de/empresa | header, hero, process-timeline, programs, trust-signals, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `familias` | /es/familias<br>/en/familias<br>/nl/familias<br>/de/familias | header, hero, guides, trust-signals, highlights, features, guides, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
| `fundador` | /es/fundador<br>/en/fundador<br>/nl/fundador<br>/de/fundador | header, hero, story, team, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `glosario` | /es/glosario<br>/en/glosario<br>/nl/glosario<br>/de/glosario | header, hero, glossary, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `guias` | /es/guias<br>/en/guias<br>/nl/guias<br>/de/guias | header, hero, guides, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
| `lifestyle` | /es/lifestyle<br>/en/lifestyle<br>/nl/lifestyle<br>/de/lifestyle | header, hero, process-timeline, programs, why-destination, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
| `prensa` | /es/prensa<br>/en/prensa<br>/nl/prensa<br>/de/prensa | header, hero, press-releases, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
| `proceso-detallado` | /es/proceso-detallado<br>/en/proceso-detallado<br>/nl/proceso-detallado<br>/de/proceso-detallado | header, hero, process-timeline, highlights, faq, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Type in FAQ search<br>- Clear search<br>- Expand/collapse question<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `proceso` | /es/proceso<br>/en/proceso<br>/nl/proceso<br>/de/proceso | header, hero, process-timeline, highlights, faq, cta-banner, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Type in FAQ search<br>- Clear search<br>- Expand/collapse question<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
| `recursos` | /es/recursos<br>/en/recursos<br>/nl/recursos<br>/de/recursos | header, hero, guides, newsletter-signup, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Fill email (if rendered)<br>- Submit signup<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | - POST /api/contact (if wired in page variant) |
...
| `sobre` | /es/sobre<br>/en/sobre<br>/nl/sobre<br>/de/sobre | header, hero, story, requirements, highlights, team, trust-signals, cta, footer, messaging-float | - Open menu<br>- Navigate via main links<br>- Switch locale<br>- Click primary CTA<br>- Click primary/secondary CTA<br>- Click CTA button<br>- Click internal links<br>- Click legal/privacy links<br>- Trigger gateway reset link (?gateway=true)<br>- Open Messaging floating action | — |
...
8. Validate external actions: Messaging links open correct number; mailto opens correct email.
