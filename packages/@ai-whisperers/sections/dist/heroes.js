...
export function PageHeroSection({ pageContent, data, images }) {
    ...
    return (_jsx("section", { className: `py-24 text-center text-white bg-cover bg-center`, style: { background: bgImage ? `linear-gradient(135deg, rgba(27,42,74,0.85), rgba(27,42,74,0.65)), url(${bgImage})` : 'linear-gradient(135deg, #1B2A4A 0%, #2C3E6B 100%)' }, children: _jsxs("div", { className: "max-w-[700px] mx-auto px-4", children: [_jsx("h1", { className: "text-[clamp(1.8rem,3.5vw,2.5rem)] font-bold leading-tight mb-3", children: headline }), (d.subheadline || d.subtitle) && _jsx("p", { className: "text-base text-white/85 leading-relaxed", children: d.subheadline || d.subtitle })] }) }));
}
